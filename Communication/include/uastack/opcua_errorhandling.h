...
typedef struct _OpcUa_StatusCodeString
{
    ...
    const OpcUa_CharA*  sString;
} OpcUa_StatusCodeString;

/*============================================================================
 * Error Handling
 *===========================================================================*/
/* Include required trace module and prepare variables. */
...
/* tests if a status code is equal the specified code. */
#define OpcUa_IsEqualTo(xCode1, xCode2) (((xCode1) & 0xFFFF0000) == ((xCode2) & 0xFFFF0000))
...
/* bit masks for the status code fields defined in part 4 */
#define OpcUa_StatusCode_Mask_Severity                      0xC0000000
#define OpcUa_StatusCode_Mask_SubCode                       0x0FFF0000
#define OpcUa_StatusCode_Mask_StructureChanged              OpcUa_StatusCode_StructureChanged
#define OpcUa_StatusCode_Mask_SemanticsChanged              OpcUa_StatusCode_SemanticsChanged
#define OpcUa_StatusCode_Mask_InfoType                      0x00000C00
#define OpcUa_StatusCode_Mask_InfoBits                      0x000003FF
#define OpcUa_StatusCode_Mask_Reserved                      0x30003000

/* get info bits portion of a status code. */
#define OpcUa_GetInfoBits(xCode)                            (((xCode) & OpcUa_StatusCode_Mask_InfoBits))

/* get info bits portion of a status code. */
#define OpcUa_GetInfoType(xCode)                            (((xCode) & OpcUa_StatusCode_Mask_InfoType))

/* get severity and sub code portion of a status code. */
#define OpcUa_GetCode(xCode)                                (((xCode) & (OpcUa_StatusCode_Mask_Severity | OpcUa_StatusCode_Mask_SubCode)))

/* get structure and semantics flags portion of a status code. */
#define OpcUa_GetFlags(xCode)                               (((xCode) & (OpcUa_StatusCode_Mask_StructureChanged | OpcUa_StatusCode_Mask_SemanticsChanged)))
