...
#if OPCUA_SERIALIZER_CHECKNESTINGDEPTH
#define OpcUa_Serializer_CheckNestingDepth(xSerializer) \
    OpcUa_ReturnErrorIfTrue((xSerializer)->NestingDepth == (xSerializer)->NestingDepthMax, OpcUa_BadEncodingLimitsExceeded); \
    (xSerializer)->NestingDepth++;
#else /* OPCUA_SERIALIZER_CHECKNESTINGDEPTH */
#define OpcUa_Serializer_CheckNestingDepth(xSerializer)
#endif /* OPCUA_SERIALIZER_CHECKNESTINGDEPTH */

#if OPCUA_SERIALIZER_CHECKNESTINGDEPTH
#define OpcUa_Serializer_ReduceNestingDepth(xSerializer) \
    (xSerializer)->NestingDepth--;
#else /* OPCUA_SERIALIZER_CHECKNESTINGDEPTH */
#define OpcUa_Serializer_ReduceNestingDepth(xSerializer)
#endif /* OPCUA_SERIALIZER_CHECKNESTINGDEPTH */
...
typedef struct _OpcUa_Decoder
{
    ...
    /*! @brief Counts nesting depth of structure elements. */
    OpcUa_UInt32 NestingDepth;

    /*! @brief Maximum nesting depth of structure elements. */
    OpcUa_UInt32 NestingDepthMax;
